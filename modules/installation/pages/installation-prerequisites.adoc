...
:description: H5Radar installation prerequisites: JDK 19, Maven, Node.js, uglifycss, uglifyjs. Ensure environment paths are set for Axion build and run.
:keywords: H5Radar, Axion, installation, prerequisites, JDK, Java, Maven, Node.js, uglifycss, uglifyjs, environment variables, setup
...
*Axion* supports different databases, H2 and PostgreSQL. See xref:database-configuration.adoc[database configuration].
